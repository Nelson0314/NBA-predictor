...
def loadAndPreprocessData(gamesPath, shotsPath, teamsPath, seqLength=10):
    ...
    featureCols = ['PTS', 'AST', 'REB', 'FG_PCT', 'STL', 'BLK', 'MIN']
    ...
    # ---------------------------------------------------------
    # print("Merging Team Stats...") # Disabled for 7-dim
    ...
    #     
    # gamesData = pd.merge( # Disabled
    #         gamesData, 
    #         teamsSubsetOwn, 
    # how='left', # Disabled
    # on=['GAME_ID', 'TEAM_ABBREVIATION'] # Disabled
    #     )
    #     
    ...
    #         teamsSubsetOpp,
    # how='left', # Disabled
    # left_on=['GAME_ID', 'OPPONENT_ABBREVIATION'], # Disabled
    # right_on=['GAME_ID', 'TEAM_ABBREVIATION'], # Disabled
    # suffixes=('', '_opp_merge') # Disabled
    #     )
    #     
    ...
    #         
    # # featureCols.extend(newTeamCols)  # Disabled for 7-dim # Disabled
    # print(f"Team Features Added: {len(newTeamCols)} columns.") # Disabled
    ...
    # featureCols.extend(new_player_cols)  # Disabled for 7-dim
    ...
    # featureCols.append('DAYS_SINCE_LAST_GAME')  # Disabled for 7-dim
