...
def get_sequences_and_features():
    ...
    # Patch: Normalize GAME_ID to 10-digit string for heatmap lookup
    if 'GAME_ID' in gamesData.columns:
        ...
        print(f'Patched GAME_ID after load. Sample: {gamesData["GAME_ID"].iloc[0]}') # DEBUG
...
def train_and_evaluate():
    ...
    # Save Report
    report_path = os.path.join("test", "baseline_report.txt")
