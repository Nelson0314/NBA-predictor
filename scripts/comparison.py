...
from src.seqModel import createSequences, NbaTransformer
from src.multiModel import loadAndPreprocessData
...
def analyze_specific_player(results, config, target_player_name="Stephen Curry", target_season_id=22025):
    ...
    if best_multi_path:
        ...
        from src.multiModel import NbaMultimodal, createMultimodalSequences
        from src.graphModel import generateHeatmap # Import Heatmap Generator
